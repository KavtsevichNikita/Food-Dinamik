...
//   const opinions = JSON.parse(localStorage.myTreesComments) || [];

//   const filteredOpinions = opinions.filter((opinion) => {
//     return (
//       opinion.name.toLowerCase().includes(searchInput) ||
//       opinion.message.toLowerCase().includes(searchInput)
//     );
//   });

//   document.getElementById("form-data").innerHTML = Mustache.render(
...
//   } else {
//     filteredOpinions = opinions.filter((opinion) => {
//       return opinion.foodRatingValue.toLowerCase() === category.toLowerCase();
//     });
//   }
